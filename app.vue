...
<script setup>
    ...
    // 懒加载非关键组件 - 不阻塞首屏渲染
    const LazyMobileWarning = defineAsyncComponent(() => 
        import('~/components/MobileWarning.vue')
    )
    const LazyCookieConsent = defineAsyncComponent(() => 
        import('~/components/CookieConsent.vue')
    )
